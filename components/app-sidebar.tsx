...
import { ChevronDown, ChevronRight, Folder, FolderOpen, Settings, Workflow, Mail, FileText, Code, Tags } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <Link href="/agent/email" className="w-full">
              ...
              <SidebarMenuItem>
                <Link href="/agent/pdf" className="w-full">
                  <SidebarMenuButton className="w-full justify-start">
              ...
              <SidebarMenuItem>
                <Link href="/agent/json" className="w-full">
                  <SidebarMenuButton className="w-full justify-start">
              ...
              <SidebarMenuItem>
                <Link href="/agent/classifier" className="w-full">
                  <SidebarMenuButton className="w-full justify-start">
                    <Tags className="w-4 h-4" />
                    <span>Classifier Agent</span>
                  </SidebarMenuButton>
                </Link>
              </SidebarMenuItem>
            </SidebarMenu>
